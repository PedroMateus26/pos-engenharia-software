package com.pedromateus.dscatalog.controller.dto;
...
public class StockDTO implements Serializable{
	...
	public StockDTO(Long id, String name, String description, Double price, String imgUrl, Instant date) {
		this.id = id;
		this.name = name;
	...
	public StockDTO(Stock entity, Set<Category> categories) {
		this(entity);
